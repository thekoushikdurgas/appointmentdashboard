...
| [`08-health.md`](modules/08-health.md)                         | [x]             | [x] _(partial)_ | `healthOperations` + `tokenBlacklistCleanup`; `useHealthStatus`; overview docs link + Operations Progress                                                                           |
| [`09-usage.md`](modules/09-usage.md)                           | [x]             | [x] _(partial)_ | `usageOperations`; `trackUsage`/`resetUsage`; `useUsage`+`useFeatureOverview`; panel tabs + tables; SuperAdmin reset                                                                |
...
| [`13-admin.md`](modules/13-admin.md)                           | [x]             | [x] _(partial)_ | `userStats`, `logs(LogQueryFilterInput)`, `searchLogs(input:LogSearchInput)`, `userHistory` all fixed                                                                               |
